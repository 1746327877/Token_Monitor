...
test('main process registers all provider adapters on startup', () => {
  ...
  assert.match(main, /require\('\.\/providers\/command-goat'\)/);
  assert.match(main, /require\('\.\/providers\/hermes'\)/);
